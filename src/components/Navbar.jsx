...
const Navbar = ({
  ...
  const handleLogout = () => {
    ...
    window.location.href = '/login'; // full reload to clear Redux state
  };
            ...
            <div className="hidden md:block flex-1 max-w-lg mx-8">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search products, categories, suppliers..."
                  className="w-full px-3 py-2 pl-10 border border-gray-300 dark:border-gray- plant rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                />
              </div>
            </div>
          )}
            ...
            <div className="pt-4 border-t border-gray-300 dark:border-gray-600 space-y-4">
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <button
                    onClick={handleLogout}
                    className="flex items-center justify-center space-x-2 w-full px-4 py-3 bg-red-500 hover:bg-red-600 text-white font-medium rounded-lg transition-colors duration-200"
                  >
                    <LogOut className="h-5 w-5" />
                    <span className="text-sm">Logout</span>
                  </button>
